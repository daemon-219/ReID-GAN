...
python examples/cluster_contrast_gan_train_usl_infomap.py --with_gan --gan_train --model AE -b 128 -a resnet50 -d market1501 --iters 200 --momentum 0.1 --eps 0.6 --num-instances 16 
