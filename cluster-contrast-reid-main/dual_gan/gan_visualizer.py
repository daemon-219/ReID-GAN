...
class Visualizer():
    def __init__(self, opt):
        ...
        self.use_html = opt.gan_train and not opt.no_html
        ...
        if self.use_html:
            ...
            gan_util.mkdirs([self.web_dir, self.img_dir])
    ...
    table td {width: %dpx; height: %dpx; padding: 4px; outline: 4px solid black}
        ...
        if self.use_html: # save images to a html file
            for label, image_numpy in visuals.items():
                ...
                gan_util.save_image(image_numpy, img_path)
            # update website
    ...
    def save_images(self, webpage, visuals, image_path):
        ...
        for label, image_numpy in visuals.items():
            ...
            gan_util.save_image(image_numpy, save_path)
